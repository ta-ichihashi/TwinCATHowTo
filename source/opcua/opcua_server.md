...
TF6100のOPC UAサーバにより追加されたユーザは、サーバとなるIPCの以下のファイルに記録されます。

WindowsのTwinCAT 3.1 Build 4024以前
  : ``` shell
    C:\TwinCAT\Functions\TF6100-OPC-UA\<platform名>\Server\TcUaSecurityConfig.xml
    ```

WindowsのTwinCAT 3.1 Build 4026以後
  : ``` shell
    C:\Program Files (x86)\Beckhoff\TwinCAT\Functions\TF6100-OPC-UA\<platform名>\Server\TcUaSecurityConfig.xml
    ```
