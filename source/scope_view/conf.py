...
project = 'Motion monitoring by scope view'
...
docx_documents = [
  ('index', 'white_paper_motion_view.docx', { 'title': 'Motion monitoring by scope view', 'creator': 'Beckhoff Automation K.K.', 'subject': 'A technical white paper for TwinCAT system', }, True),
]
