...
#  ## DEPRECATED: The "riemann_legacy" plugin is deprecated in version 1.3.0 and will be removed in 1.30.0, use 'outputs.riemann' instead (see https://github.com/influxdata/telegraf/issues/1878).
